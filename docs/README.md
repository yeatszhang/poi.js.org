...
> *Note: Poi supports all frameworks but only Vue has built-in support, for other frameworks like React and Svelte etc. please use a [preset](https://git.skyeye.world/FE/poi/tree/master/packages) or see how to [configure](#config-file).*
